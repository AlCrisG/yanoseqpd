...
public class Curp {
    public static String crearCurp(String nombre, String primerApellido, String segundoApellido, Genero genero, LocalDate fechaNacimiento, Estado estado){
        String primeraLetra = Character.toString(primerApellido.charAt(0)).toUpperCase();
        String segundaLetra = primeraVocalPalabra(primerApellido);
        String terceraLetra = Character.toString(segundoApellido.charAt(0)).toUpperCase();
        String cuartaLetra = Character.toString(nombre.charAt(0)).toUpperCase();
